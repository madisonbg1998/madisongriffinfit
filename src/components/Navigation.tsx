...
export function Navigation() {
  ...
  return (
    <>
              ...
              >
                <span
                  className={`block h-[1.5px] w-6 transition-all duration-400 ease-out ${
                    isMobileOpen ? 'bg-midnight' : isScrolled || forceDark ? 'bg-midnight' : 'bg-cream'
      ...
      {/* Mobile Menu Overlay — sibling to header so it's not clipped by the header's stacking context */}
      <div
        className={`fixed inset-0 bg-cream z-[60] transition-all duration-500 ease-out lg:hidden ${
          isMobileOpen
